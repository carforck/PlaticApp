...
function buildPrompt(ctx: InterpretContext): string {
  return [
    ...
    "Si mueve plata entre SUS propias cuentas, kind=transfer, account=ORIGEN y transferTo=DESTINO. No es gasto ni ingreso. Reconoce muchas formas de pedirlo: «pasé/pasa/pásame 100 mil de Nequi a Bancolombia», «mueve 50 mil de X a Y», «manda/transfiere de X a Y», «saca del banco y mete en efectivo», «retiré del banco a efectivo». Si solo dice una cuenta (ej. «saqué 100 mil del cajero»), el destino es efectivo.",
