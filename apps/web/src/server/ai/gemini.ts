...
function buildPrompt(ctx: InterpretContext): string {
  return [
    ...
    "IMPORTANTE: pagarle, transferirle, prestarle o enviarle plata a OTRA PERSONA (novia, amigo, «a Sebastián», «a mi novia», «le pagué a Juan») NO es transfer. Es un GASTO (kind=expense). NUNCA crees una cuenta con el nombre de una persona ni la pongas como transferTo.",
